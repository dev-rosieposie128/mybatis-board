...
public class PostRequest {
    ...
    public PostRequest(Long postId, String title, String content, int viewCnt, int replyCnt, long userId, long nUserId, long nPwd, boolean delYn, LocalDateTime regDt, LocalDateTime mdfDt, Long boardId) {
        this.postId = postId;
        this.title = title;
